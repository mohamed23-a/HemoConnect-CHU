...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-blue-600 hover:bg-blue-700 text-white shadow-sm shadow-blue-200/50",
    secondary: "bg-slate-600 hover:bg-slate-700 text-white",
    success:
      "bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm shadow-emerald-200/50",
    danger:
      "bg-red-600 hover:bg-red-700 text-white shadow-sm shadow-red-200/50",
  ...
  return (
    ...
    >
      {loading ? (
        <LoadingSpinner
          size="sm"
          color={["outline", "ghost"].includes(variant) ? "blue" : "white"}
        />
      ) : (
