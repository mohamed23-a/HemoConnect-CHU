    ...
    <div className="space-y-6">
      ...
      >
        <StatCard
          ...
          value={stats?.total_demandes ?? stats?.demandes_count}
        ...
        />
        <StatCard
          title={t("stats.total_users") || "Utilisateurs"}
          value={stats?.total_users ?? stats?.users_count}
          icon={UserGroupIcon}
          gradient="bg-emerald-500"
        />
        <StatCard
          title={t("stats.blood_types_available") || "Types de sang"}
          value={stats?.blood_types_count ?? stats?.blood_stock_count}
          icon={BeakerIcon}
          gradient="bg-red-500"
        />
      </motion.div>
              ...
              <table className="t-table">
                <thead className="t-head">
                  <tr>
                    ...
                    <th className="t-th">
                      {t("stock.quantity")} ({t("stock.units")})
                    </th>
        ...
        >
          <Card title={t("stats.by_status")}>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {Object.entries(stats.demandes_by_status).map(
                ([status, count]) => {
                  const gradients = {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`w-8 h-1.5 rounded-full mb-3 ${gradients[status] || "bg-gray-400"}`}
                      />
                      <p
