        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="relative">
            ...
            <input
              ...
              style={{
                paddingRight:
                  document.documentElement.dir === "rtl" ? "36px" : "12px",
                paddingLeft:
                  document.documentElement.dir === "rtl" ? "12px" : "36px",
              }}
              value={search}
          ...
          <table className="t-table">
            <thead className="t-head">
              <tr>
                ...
                {user?.role !== "hospital" && (
                  <th className="t-th">{t("historique.processed_at")}</th>
                )}
              </tr>
            </thead>
            <tbody className="t-body">
              {filtered.map((d) => (
                <tr key={d.id}>
                  ...
                  {user?.role !== "hospital" && (
                    <td className="t-td t-td-muted">
                      {d.treated_at
                        ? new Date(d.treated_at).toLocaleDateString()
                        : "—"}
                    </td>
                  )}
                </tr>
              ...
              {filtered.length === 0 && (
                <tr>
                  <td
                    colSpan={user?.role !== "hospital" ? 8 : 6}
