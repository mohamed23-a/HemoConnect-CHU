...
import { CheckCircleIcon, HeartIcon, ShieldCheckIcon, BoltIcon } from '@heroicons/react/24/outline'
      ...
      <div className="space-y-6">
        ...
        <div className="text-center space-y-3">
          <div className="w-20 h-20 mx-auto bg-white rounded-2xl p-2 shadow-sm border dark:bg-gray-800 dark:border-gray-700">
            <img src="/logo.png" alt="HemoConnect CHU Logo" className="w-full h-full object-contain" />
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              { icon: BoltIcon, color: 'text-amber-500', text: t('about.feat_1') },
              { icon: ShieldCheckIcon, color: 'text-emerald-500', text: t('about.feat_2') },
              { icon: CheckCircleIcon, color: 'text-blue-500', text: t('about.feat_3') },
              { icon: HeartIcon, color: 'text-red-500', text: t('about.feat_4') }
            ].map((f, i) => (
              <div key={i} className="flex items-start gap-2.5 p-3 rounded-xl border bg-gray-50 lg:bg-white dark:bg-gray-800/50 dark:border-gray-700">
        ...
        <div className="pt-4 border-t dark:border-gray-700 flex justify-center">
          <p className="text-xs text-gray-400 font-medium whitespace-pre-wrap text-center" dir="ltr">
